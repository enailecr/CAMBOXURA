...
from .views import list, busca_logs, lista_logs_cambox, lista_logs_server, busca_logs_cambox, busca_logs_server
...
urlpatterns = [
    ...
    url(r'servidor-busca/',busca_logs_server, name='busca_logs_server'),
]
