...
class ChamadaEmGrupo(Destino):
    ...
    anuncioRemoto =  models.ForeignKey(Anuncio, on_delete=models.CASCADE, related_name='anuncioRemotoCG')
    anuncioTardio =  models.ForeignKey(Anuncio, on_delete=models.CASCADE,related_name='anuncioTardioCG')
